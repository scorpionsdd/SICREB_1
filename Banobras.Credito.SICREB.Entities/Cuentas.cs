...
namespace Banobras.Credito.SICREB.Entities
{
    public class Cuentas
    {
        ...
        public Cuentas(int pId, string pCodigo, string pDescripcion, string pSector, string pRol, int pIdClasificacion, string pDescripcionClasif, string pFormatSic, string pFormatSicofin, Enums.Persona pPersona, int pGrupo, Enums.Estado pEstatus,string pTipo)
        {
            this.Id = pId;
            this.Codigo = pCodigo;
