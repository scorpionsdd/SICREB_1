...
namespace Banobras.Credito.SICREB.Entities
{
    public class Nacionalidad
    {
        ...
        /// <summary>
        /// Crea una entidad de Catalogo Nacionalidad
        /// </summary>
        ...
        public Nacionalidad(int id, int claveSIC, string claveBuro, string descripcion, Enums.Persona tipoPersona, Enums.Estado estatus)
        {
            this.Id = id;
