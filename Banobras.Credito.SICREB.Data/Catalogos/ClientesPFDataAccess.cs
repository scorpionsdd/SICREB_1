...
{
    public class ClientesPFDataAccess : OracleBase
    {
        ...
        public ClientesPFDataAccess()
        {
        }

        public List<ClientesPF> GetRecords()
        {
            List<ClientesPF> toReturn = new List<ClientesPF>();
            DbCommand cmd = DB.GetStoredProcCommand(StoredProcedure);
            DB.AddInParameter(cmd, "pPersona", DbType.String, "PF");
        ...
        public ClientesPF GetEntity(IDataReader reader)
        {
            ...
            string str_tmp = reader["FECHA_NAC"].ToString().Trim(); //01/01/2001 12:00:00 a.m.

            if (str_tmp.Equals("01/01/2001 12:00:00 a.m.") || str_tmp.Equals("01/01/0001 12:00:00 a.m."))
            {
                str_tmp = String.Empty;
            }
            else
            {
                if (str_tmp.Length > 6)
            ...
            string Estado_civil_clave = reader["ESTADO_CIVIL_CLAVE"].ToString();
            string Estado_civil = reader["ESTADO_CIVIL"].ToString();
        ...
        public int UpdateRecord(ClientesPF entityOld, ClientesPF entityNew)
        {
        ...
        public int InsertRecord(ClientesPF entity)
        {
            int filasAfectadas = 0;
            try
            {
        ...
        {
            get { return "PACKCLIENTES.SP_UPDATE_PF"; }
        }
        public string StoredProcedureInsert
        {
            get { return "PACKCLIENTES.SP_INSERT_PF"; }
        }
        public string StoredProcedureDelete
        {
            get { return "PACKCLIENTES.SP_DELETE_PF"; }
        }

        public string StoredProcedureDeleteAll
        {
            get { return "PACKCLIENTES.SP_DELETEALL_PF"; }
        }


        public void SetEntity(DbCommand cmd, ClientesPF entityOld, ClientesPF entityNew)
        {
            ...
            if (entityNew.Fecha_nac != null && entityNew.Fecha_nac.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pFecha_nac", DbType.AnsiString, entityNew.Fecha_nac.ToString()); }

            if (entityNew.Estado_civil_clave != null && entityNew.Estado_civil_clave.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pEstado_civil_clave", DbType.AnsiString, entityNew.Estado_civil_clave.ToString()); }

            if (entityNew.Estado_civil != null && entityNew.Estado_civil.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pEstado_civil", DbType.AnsiString, entityNew.Estado_civil.ToString()); }

            if (entityNew.Sexo != null && entityNew.Sexo.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pSexo", DbType.AnsiString, entityNew.Sexo.ToString()); }
        ...
        public void SetEntityInsert(DbCommand cmd, ClientesPF entityToInsert)
        {
            ...
            if (entityToInsert.Fecha_nac != null && entityToInsert.Fecha_nac.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pFecha_nac", DbType.AnsiString, entityToInsert.Fecha_nac.ToString()); }

            if (entityToInsert.Estado_civil_clave != null && entityToInsert.Estado_civil_clave.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pEstado_civil_clave", DbType.AnsiString, entityToInsert.Estado_civil_clave.ToString()); }

            if (entityToInsert.Estado_civil != null && entityToInsert.Estado_civil.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pEstado_civil", DbType.AnsiString, entityToInsert.Estado_civil.ToString()); }

            if (entityToInsert.Sexo != null && entityToInsert.Sexo.ToString().Trim() != "")
            { DB.AddInParameter(cmd, "pSexo", DbType.AnsiString, entityToInsert.Sexo.ToString()); }
