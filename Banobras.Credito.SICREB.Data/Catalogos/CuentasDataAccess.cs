...
namespace Banobras.Credito.SICREB.Data.Catalogos
{
    ...
    public class CuentasDataAccess : CatalogoBase<Cuentas, int>
    {
        ...
        public override String ErrorInsert { get { return "1040 - Error al insertar nuevo registro en catálogo Cuentas."; } }
        public override String ErrorUpdate { get { return "1041 - Error al actualizar registro en catálogo Cuentas."; } }
        public override String ErrorDelete { get { return "1042 - Error al borrar el registro en catálogo Cuentas."; } }

        public CuentasDataAccess(Enums.Persona pers)
            : base(pers)
        {

        }

        public override Cuentas GetEntity(IDataReader reader, out bool activo)
        {
            ...
            Cuentas cuenta = new Cuentas(idValue, codigo, descripcion, sector, rol, clasificacion, descripcionClasif, formatoSic, formatoSicofin, persona, grupo, estado,tipocuenta);
        ...
        {
            get { return "CATALOGOS.SP_CATALOGOS_GetCuentas"; }
        }

        public override string StoredProcedureUpdate 
        {
            get { return "PACKCUENTAS.SpUpdate"; }
        }

        public override string StoredProcedureInsert
        {
            get { return "PACKCUENTAS.SpInsert"; }
        }

        public override string StoredProcedureDelete
        {
            get { return "PACKCUENTAS.SpDelete"; }
        }

        public override void SetEntity(DbCommand cmd, Cuentas entityOld, Cuentas entityNew)
        {
        ...
        public override void SetEntityDelete(DbCommand cmd, Cuentas entityToDelete)
        {
        ...
        public override void SetEntityInsert(DbCommand cmd, Cuentas entityToInsert)
        {
        ...
        public List<int> GetGrupos()
        {
            ...
            try
            {
                ...
                string query = "SELECT distinct grupo from T_CUENTAS WHERE ESTATUS = '1'";
