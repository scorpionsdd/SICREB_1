<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ConvertidorCuentasGL.aspx.cs" Inherits="ConvertidorCuentasGL" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp; <asp:Label runat="server" ID="lblTitle" Text="Convertidor de Cuentas (Lineas y Garantias)" />
            </td>
        ...
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCuentas" AutoGenerateColumns="false" AllowScroll="true" 
                    ...
                    OnNeedDataSource="RgdCuentas_NeedDataSource" OnUpdateCommand="RgdCuentas_UpdateCommand" OnInsertCommand="RgdCuentas_InsertCommand">
                    <ExportSettings FileName="ConvertidorCuentasGL" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="Convertidor de Cuentas (Lineas y Garantias)" />
                    </ExportSettings>
                    ...
                    <MasterTableView Name="MtvCuentas" DataKeyNames="ID_CONVERTIDOR" NoMasterRecordsText="No existen Registros" CommandItemDisplay="Top" EditMode="InPlace" Width="99%">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Id"                                DataField="ID_CONVERTIDOR" UniqueName="Id"             HeaderStyle-HorizontalAlign="Justify" DataType="System.Int32" MaxLength="3" Visible="false" />                            
                            <telerik:GridBoundColumn HeaderText="Cuenta Actual"                     DataField="CUENTA_ACT"     UniqueName="Cuenta_Vencida" HeaderStyle-HorizontalAlign="Justify" HeaderStyle-Width="170px" FilterControlWidth="80%" DataType="System.String" MaxLength="30" />                            
                            <telerik:GridBoundColumn HeaderText="Cuenta Anterior (Buro de Crédito)" DataField="CUENTA_ANT"     UniqueName="Cuenta_Vigente" HeaderStyle-HorizontalAlign="Justify" HeaderStyle-Width="300px" FilterControlWidth="80%" DataType="System.String" MaxLength="200" />                                                                                                                                   
