<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CreditosExceptuadosGL.aspx.cs" Inherits="CreditosExceptuadosGL" %>
...
<asp:Content Runat="Server" ID="Content2" ContentPlaceHolderID="MainContent">
    ...
    <script type="text/javascript">
        ...
        function msj() {
            ...
            var chk = document.getElementById('MainContent_RgdCreditos_ctl00_ctl02_ctl02_ChkTodo');
            ...
            if (chk.checked) {
                ...
                if (num == 0) {
                    ...
                    var answer = confirm("Esta seguro que desea eliminar " + num + " egistros del Catalogo de Créditos Exeptuados");
                    if (answer) {
                        return true;
                    }
                    else {
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp; <asp:Label runat="server" ID="lblTitle" Text="Catalogo de Creditos Exceptuados (Lineas y Garantias)" />
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="table-layout:fixed;">
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCreditos" AutoGenerateColumns="false" AllowScroll="true" 
                    AllowSorting="true" AllowPaging="true" PageSize="10" AllowFilteringByColumn="True"
                    OnNeedDataSource="RgdCreditos_NeedDataSource" OnUpdateCommand="RgdCreditos_UpdateCommand" OnInsertCommand="RgdCreditos_InsertCommand">
                    <ExportSettings FileName="CreditosExceptuadosGL" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="Créditos Exceptuados" />
                    </ExportSettings>
                    ...
                    <MasterTableView Name="MtvCreditos" DataKeyNames="ID" NoMasterRecordsText="No existen Registros" CommandItemDisplay="Top" EditMode="InPlace" Width="99%">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Id"      DataField="ID"      UniqueName="ID" HeaderStyle-HorizontalAlign="Justify" DataType="System.Int32" MaxLength="3" Visible="false" />                            
                            <telerik:GridBoundColumn HeaderText="Crédito" DataField="CREDITO" UniqueName="Credito" HeaderStyle-HorizontalAlign="Justify" HeaderStyle-Width="170px" FilterControlWidth="80%" DataType="System.String" MaxLength="30" />                            
                            <telerik:GridBoundColumn HeaderText="Motivo"  DataField="MOTIVO"  UniqueName="Motivo" HeaderStyle-HorizontalAlign="Justify" HeaderStyle-Width="300px" FilterControlWidth="80%" DataType="System.String" MaxLength="100" />                                                                                                                                   
