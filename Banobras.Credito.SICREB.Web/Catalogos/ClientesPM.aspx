<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ClientesPM.aspx.cs" Inherits="Catalogos_ClientesPM" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label runat="server" ID="lblTitle" Text="Catálogo Intermedio de FS-Clientes Personas Morales"></asp:Label>
            </td>
        ...
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCuentas" AutoGenerateColumns="false" AllowScroll="true"
                    ...
                    <ExportSettings FileName="Clientes_PM" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                    ...
                    <MasterTableView Name="MtvCuentas" NoMasterRecordsText="No existen Registros"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="COMPAÑÍA" HeaderStyle-HorizontalAlign="Justify"
                                HeaderStyle-Width="170px" UniqueName="COMPANIA" DataField="COMPANIA" 
                                DataType="System.String" MaxLength="4000">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="CLAVE DE ACT. ECO." HeaderStyle-HorizontalAlign="Justify"
                                HeaderStyle-Width="100px" FilterControlWidth="80%" UniqueName="ACT_ECO_CLAVE" DataField="ACT_ECO_CLAVE" 
                                DataType="System.String" MaxLength="7">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="ACTIVIDAD ECONÓMICA." HeaderStyle-HorizontalAlign="Justify"
                                HeaderStyle-Width="100px" FilterControlWidth="80%" UniqueName="ACT_ECO" DataField="ACT_ECO"
