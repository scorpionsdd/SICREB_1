<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="FrecuenciaPagosPage.aspx.cs" Inherits="Catalogos_FrecuenciaPagosPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <script type="text/javascript">
        function msj() {
            ...
            var chk = document.getElementById('MainContent_RgdFrecuenciaPagos_ctl00_ctl02_ctl02_ChkTodo');
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label runat="server" ID="lblTitle" Text="FRECUENCIA DE PAGOS DE INTERESES"></asp:Label>
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdFrecuenciaPagos" AutoGenerateColumns="false"
                    AllowSorting="true" AllowPaging="true" PageSize="10" OnNeedDataSource="RgdFrecuenciaPagos_NeedDataSource"
                    AllowFilteringByColumn="True" OnEditCommand="RgdFrecuenciaPagos_EditCommand"
                    OnUpdateCommand="RgdFrecuenciaPagos_UpdateCommand" OnColumnCreated="RgdFrecuenciaPagos_ColumnCreated"
                    OnDeleteCommand="RgdFrecuenciaPagos_DeleteCommand" OnInsertCommand="RgdFrecuenciaPagos_InsertCommand"
                    OnItemDataBound="RgdFrecuenciaPagos_ItemDataBound">
                    <ExportSettings FileName="Frecuencias Pago" IgnorePaging="false" OpenInNewWindow="true"
                        ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="Frecuencias Pago" />
                    </ExportSettings>
                    ...
                    <MasterTableView Name="MtvFrecuenciaPagos" DataKeyNames="ID" NoMasterRecordsText="No existen Registros"
                        CommandItemDisplay="Top" EditMode="InPlace" Width="100%">
                        <CommandItemSettings ShowRefreshButton="true" AddNewRecordText="Agregar Frecuencia de pago"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Clave SIC" HeaderStyle-Width="40%" ItemStyle-Width="40%"
