...
public partial class ClasificacionPage : System.Web.UI.Page
{
    //MASS 27-jun-2013
    public const String catalog = "Clasificación Activos";        
    int idUs;
    int SeleccionTipo = -1;
    ...
    {        
        //MASS 27-jun-2013
        ClasificacionActivos_Rules getRecords = null;
        List<ClasificacionActivos> cuentasInfo;
        List<string> lsCodigo = new List<string>();
        RgdCuentas.EnableLinqExpressions = false;

        try
        {
            getRecords = new ClasificacionActivos_Rules();
    ...
    protected void RgdCuentas_UpdateCommand(object source, GridCommandEventArgs e)
    {
        ...
        //MASS 27-jun-2013
        ClasificacionActivos cuentaOld;
        ClasificacionActivos cuentaNew;                
        ...
        try
        {
            if (newValues["descripcion"] != null && newValues["vigente"] != null)
            {
                ...
                if (Actualizar)
                {
                    ...
                    //MASS 27-jun-2013
                    cuentaOld = new ClasificacionActivos(id, Descripcion, sEstatusClasOld);
                    cuentaNew = new ClasificacionActivos(id, Descripcion, EstatusClas);

                    //Llamar el SP correspondiente con las entidades old y new de Validacion
                    //MASS 27-jun-2013
                    ClasificacionActivos_Rules CuentaValores = new ClasificacionActivos_Rules();
    ...
    {
        //MASS 27-jun-2013        
        ClasificacionActivos CuentaDelete;
        ...
        try
        {
            ...
            //MASS 27-jun-2013                        
            CuentaDelete = new ClasificacionActivos(idCuenta, "", "");

            //Llamar el SP correspondiente con las entidades old y new de Validacion

            //MASS 27-jun-2013            
            ClasificacionActivos_Rules CuentaBorrar = new ClasificacionActivos_Rules();
    ...
    {
        //MASS 27-jun-2013
        ClasificacionActivos_Rules CuentaInsertar;
       
        try
        {
            //MASS 27-jun-2013
            ClasificacionActivos record = this.ValidaNulos(e.Item as GridEditableItem);
            ...
            {   //si trae informacion valida hara la insercion
                if (record.descripcion != string.Empty && record.vigente != string.Empty)
                {
                    ...
                    {
                        //MASS 27-jun-2013
                        CuentaInsertar = new ClasificacionActivos_Rules();
    ...
    //MASS 27-jun-2013
    private ClasificacionActivos ValidaNulos(GridEditableItem editedItem)
    {
        Hashtable newValues = new Hashtable();

        //MASS 27-jun-2013
        ClasificacionActivos record;        
        ...
        if (newValues.Count > 0)
        {
            if (newValues["descripcion"] != null)
            {
                ...
                //MASS 27-jun-2013                
                record = new ClasificacionActivos(0, newValues["descripcion"].ToString(), estado_clas);
            ...
            {
                //MASS 27-jun-2013                
                record = new ClasificacionActivos(0, string.Empty, "");
    ...
    protected void btn_cargar_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (file_txt_layout.HasFile)
            {
                ...
                //MASS 19-jun-2014
                string storeBase = "PACKCLASIFICACION_ACTIVOS.SP_CARGAMASIVA";

                dt_layout_procesado = cargaMasiva.cargaMasiva("cat_clasificacion_activos", dt_metaDataLayout, ruta_archivo, " * ", parametros, storeBase, "");
    ...
    protected void btn_eliminar_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (chkHeader.Checked == true)
            {
                ...
                {
                    //MASS 27-jun-2013
                    ClasificacionActivos CuentasDelete;

                    int pId = Parser.ToNumber(row.GetDataKeyValue("id").ToString());

                    //MASS 27-jun-2013                    
                    CuentasDelete = new ClasificacionActivos(pId, "", "");

                    //Aqui debo mandar llamar el SP correspondiente con las entidades old y new de Validacion                    

                    //MASS 27-jun-2013
                    ClasificacionActivos_Rules CuentasBorrar = new ClasificacionActivos_Rules();
