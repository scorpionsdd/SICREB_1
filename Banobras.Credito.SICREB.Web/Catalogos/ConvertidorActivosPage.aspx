<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="ConvertidorActivosPage.aspx.cs" Inherits="ConvertidorActivosPage" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label runat="server" ID="lblTitle" Text="CONVERTIDOR ACTIVOS"></asp:Label>
            </td>
            ...
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCuentas" AutoGenerateColumns="false" AllowScroll="true" OnItemCommand="grids_ItemCommand"
                    ...
                    OnInsertCommand="RgdCuentas_InsertCommand" OnItemDataBound="RgdCuentas_ItemDataBound">
                     <ExportSettings FileName="Convertidor_Activos" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                    ...
                    <MasterTableView Name="MtvCuentas" DataKeyNames="id_convertidor" NoMasterRecordsText="No existen Registros"
                        ...
                        <Columns>                        
                            ...
                            <telerik:GridBoundColumn HeaderText="Auxiliar" HeaderStyle-HorizontalAlign="Justify" HeaderStyle-Width="130px" FilterControlWidth="80%"
                                UniqueName="auxiliar" DataField="auxiliar" DataType="System.String" MaxLength="50">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Crédito" HeaderStyle-HorizontalAlign="Justify" HeaderStyle-Width="130px" FilterControlWidth="80%"
                                UniqueName="credito" DataField="credito" DataType="System.String" MaxLength="18">
                            </telerik:GridBoundColumn>
