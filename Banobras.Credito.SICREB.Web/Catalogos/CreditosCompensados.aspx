<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CreditosCompensados.aspx.cs" Inherits="CreditosCompensados" %>
...
<asp:Content Runat="Server" ID="Content2" ContentPlaceHolderID="MainContent">
    ...
    <script type="text/javascript">
        ...
        function msj() {
            ...
            var chk = document.getElementById('MainContent_RgdCreditosC_ctl00_ctl02_ctl02_ChkTodo');
            var total = document.getElementById('tot');
            var chks = getElementsByClassNameIE("chks");

            if (chk.checked) {
                var answer = confirm("Esta seguro que desea eliminar " + total.innerHTML + " Registros del Catalogo de Créditos Compensados PM");
                if (answer) {
                    return true;
                }
                else {
                ...
                if (num == 0) {
                    ...
                    var answer = confirm("Esta seguro que desea eliminar " + num + " registros del Catalogo de Créditos Compensados PM");
                    if (answer) {
                        return true;
                    }
                    else {
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp; <asp:Label runat="server" ID="lblTitle" Text="Catalogo de Créditos Compensados" />
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="table-layout:fixed;">
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCreditosC" AutoGenerateColumns="false" AllowScroll="true" 
                                 AllowSorting="true" AllowPaging="true" PageSize="10" AllowFilteringByColumn="True"
                                 OnNeedDataSource="RgdCreditosC_NeedDataSource" OnUpdateCommand="RgdCreditosC_UpdateCommand" OnInsertCommand="RgdCreditosC_InsertCommand">
                    <ExportSettings FileName="CreditosCompensados" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="Créditos Compensados" />
                    </ExportSettings>
                    ...
                    <MasterTableView Name="MtvCreditos" DataKeyNames="ID_CREDITO" NoMasterRecordsText="No existen Registros" CommandItemDisplay="Top" EditMode="InPlace" Width="99%">
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Número de Credito"     DataField="CREDITO"      UniqueName="Credito"     HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100px"  FilterControlWidth="80%" DataType="System.String" MaxLength="30" />
                            <telerik:GridBoundColumn HeaderText="RFC Acreditado"        DataField="RFC"          UniqueName="Rfc"         HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Width="100px"  FilterControlWidth="80%" DataType="System.String" MaxLength="30" />
                            <telerik:GridBoundColumn HeaderText="Nombre del Acreditado" DataField="ACREDITADO"   UniqueName="Acreditado"  HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Width="250px" FilterControlWidth="80%" DataType="System.String" MaxLength="250" />
                            <telerik:GridBoundColumn HeaderText="Informacion"           DataField="INFORMACION"  UniqueName="Informacion" HeaderStyle-HorizontalAlign="Left"  HeaderStyle-Width="250px" FilterControlWidth="80%" DataType="System.String" MaxLength="250" />
