<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="ClasificacionPage.aspx.cs" Inherits="ClasificacionPage" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label runat="server" ID="lblTitle" Text="CLASIFICACIÓN ACTIVOS"></asp:Label>
            </td>
            ...
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCuentas" AutoGenerateColumns="false" 
                    ...
                    oncancelcommand="RgdCuentas_CancelCommand">
                     <ExportSettings FileName="Clasificacion_Activos" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="Clasificación" />
                    </ExportSettings>
