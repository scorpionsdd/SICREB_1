<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="ClavesObservacionPage.aspx.cs" Inherits="ClaveObservacionPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <script type="text/javascript">
        function msj() {
            ...
            var chk = document.getElementById('MainContent_RgdObservacion_ctl00_ctl02_ctl02_ChkTodo');
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label Text="CLAVES DE OBSERVACIÓN" runat="server" ID="lblTitle"></asp:Label>
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        <tr>
            <td colspan="3" id="td2" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdObservacion" AutoGenerateColumns="false"  AllowSorting="true" OnItemCommand="grids_ItemCommand"
                    AllowPaging="true" PageSize="10" OnNeedDataSource="RgdObservacion_NeedDataSource"
                    AllowFilteringByColumn="True" OnEditCommand="RgdObservacion_EditCommand" OnUpdateCommand="RgdObservacion_UpdateCommand"
                    OnColumnCreated="RgdObservacion_ColumnCreated" OnDeleteCommand="RgdObservacion_DeleteCommand"
                    OnInsertCommand="RgdObservacion_InsertCommand" OnItemDataBound="RgdObservacion_ItemDataBound">
                    <FooterStyle HorizontalAlign="Right" VerticalAlign="Middle" Wrap="False" />
                    <ExportSettings FileName="ClaveObservacion" IgnorePaging="false" OpenInNewWindow="true"
                        ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="ClaveObservacion" />
                    </ExportSettings>
                    ...
                    <MasterTableView Name="MtvEstados" NoMasterRecordsText="No existen Registros" CommandItemDisplay="Top"
                        ...
                        <CommandItemSettings ShowRefreshButton="true" AddNewRecordText="Agregar Observación"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="Id" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                HeaderStyle-HorizontalAlign="Left" UniqueName="Id" DataField="id" DataType="System.String"
                                MaxLength="10" Visible="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Clave" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                HeaderStyle-HorizontalAlign="Left" UniqueName="Clave" DataField="Clave" DataType="System.String"
                                MaxLength="5">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn HeaderText="Comentario" HeaderStyle-Width="30%" ItemStyle-Width="30%"
                                HeaderStyle-HorizontalAlign="Left" UniqueName="comentario" DataField="comentario"
                                DataType="System.String" MaxLength="200">
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn HeaderText="Persona" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                HeaderStyle-HorizontalAlign="Left" UniqueName="Persona" DataField="Persona" DataType="System.String"
                            ...
                            <telerik:GridBoundColumn HeaderText="Estatus" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                HeaderStyle-HorizontalAlign="Left" UniqueName="Estatus" DataField="Estatus" DataType="System.String  "
                                MaxLength="1" Visible="false">
                            </telerik:GridBoundColumn>
