<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="CuentasActPage.aspx.cs" Inherits="CuentasActPage" %>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label runat="server" ID="lblTitle" Text="CUENTAS NUEVAS"></asp:Label>
            </td>
        ...
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdCuentas" AutoGenerateColumns="false" AllowScroll="true"
                    ...
                    OnNeedDataSource="RgdCuentas_NeedDataSource" AllowFilteringByColumn="True" OnEditCommand="RgdCuentas_EditCommand"
                    OnUpdateCommand="RgdCuentas_UpdateCommand" OnColumnCreated="RgdCuentas_ColumnCreated"
                    ...
                    <MasterTableView Name="MtvCuentas" DataKeyNames="Id" NoMasterRecordsText="No existen Registros"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn Visible="false" HeaderText="Catálogo" UniqueName="TipoCatalogo"
                                AllowFiltering="false" FilterControlWidth="50%" HeaderStyle-Width="90px">
                                <ItemTemplate>
                                    <telerik:RadComboBox runat="server" ID="ComboCatalogo" ReadOnly="true"
                                        AutoPostBack="true" OnSelectedIndexChanged="FiltroCombo_SelectedIndexChanged">
                                        <Items>
                                            <telerik:RadComboBoxItem Text="Cat. Anterior" Value='0' />
                                            <telerik:RadComboBoxItem Text="Cat. IFRS9" Value='1' />
                                        </Items>
                                    </telerik:RadComboBox>                                    
                                </ItemTemplate>
                                <%--<asp:textbox id="txtMeetPlaceOther" text='<%# Bind("Id") %>' runat="server" />--%>
