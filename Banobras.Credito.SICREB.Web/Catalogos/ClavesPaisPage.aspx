<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeFile="ClavesPaisPage.aspx.cs" Inherits="Catalogos_ClavesPaisPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <script type="text/javascript">
        function msj() {
            ...
            var chk = document.getElementById('MainContent_RgdClavesPais_ctl00_ctl02_ctl02_ChkTodo');
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        ...
        <tr>
            ...
            <td id="tdRubroAll" class="titleCenter">
                &nbsp;<asp:Label runat="server" ID="lblTitle" Text="CLAVES PAÍS"></asp:Label>
            </td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
        <tr>
            <td colspan="3" id="td1" width="100%">
                ...
                <telerik:RadGrid runat="server" ID="RgdClavesPais" AutoGenerateColumns="false" AllowSorting="true"
                    AllowPaging="true" PageSize="10" OnNeedDataSource="RgdClavesPais_NeedDataSource"
                    AllowFilteringByColumn="True" OnEditCommand="RgdClavesPais_EditCommand" OnUpdateCommand="RgdClavesPais_UpdateCommand"
                    OnColumnCreated="RgdClavesPais_ColumnCreated" OnDeleteCommand="RgdClavesPais_DeleteCommand"
                    OnInsertCommand="RgdClavesPais_InsertCommand">
                    <ExportSettings FileName="Pais" IgnorePaging="false" OpenInNewWindow="true" ExportOnlyData="true">
                        <Pdf PaperSize="Letter" PageTitle="PAIS" />
                    </ExportSettings>
                    ...
                    <MasterTableView Name="MtvClavesPais" DataKeyNames="ID" NoMasterRecordsText="No existen Registros"
                        ...
                        <CommandItemSettings ShowRefreshButton="true" AddNewRecordText="Agregar Clave de País"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="ID" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                ...
                                DataType="System.Int32" MaxLength="38" Visible="false">
                            </telerik:GridBoundColumn>
                            <telerik:GridNumericColumn HeaderText="Clave SIC" HeaderStyle-Width="23%" ItemStyle-Width="23%"
                                HeaderStyle-HorizontalAlign="Justify" UniqueName="CLAVESIC" DataField="CLAVESIC"
                                DataType="System.Int32" MaxLength="38">
                            </telerik:GridNumericColumn>
                            <telerik:GridBoundColumn HeaderText="Clave Buró" HeaderStyle-Width="23%" ItemStyle-Width="23%"
                                HeaderStyle-HorizontalAlign="Justify" UniqueName="CLAVEBURO" DataField="CLAVEBURO"
                                DataType="System.String" MaxLength="2">
                            </telerik:GridBoundColumn>
                            <telerik:GridBoundColumn HeaderText="Descripción" HeaderStyle-Width="24%" ItemStyle-Width="24%"
