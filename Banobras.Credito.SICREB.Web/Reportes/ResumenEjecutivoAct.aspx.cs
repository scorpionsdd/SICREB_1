...
public partial class Reportes_ResumenEjecutivoAct : System.Web.UI.Page
{
    ...
    protected void ObtenDatosPersonaFisica()
    {
        ...
        this.rgConciliacion_PF.DataSource = ReporteConciliacionesDataAccess.GetResumen_PFTest();
        //<MASS>
        this.rgConciliacion_PF.DataBind();
    }
    ...
    protected void ObtenDatosPersonaMorales()
    {
        ...
        this.rgConciliacion_PM.DataSource = ReporteConciliacionesDataAccess.GetResumen_PMTest();
        //<MASS>
        this.rgConciliacion_PM.DataBind();
    }
