<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ResumenEjecutivoAct.aspx.cs" Inherits="Reportes_ResumenEjecutivoAct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">   
    ...
    <div class="divCard">
            ...
            <telerik:RadGrid 
                ...
                <MasterTableView AllowPaging="True" AllowSorting="True" CommandItemDisplay="None" AllowFilteringByColumn="True">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn HeaderText="Saldo Actual (Etiqueta 22)" DataField="SALDO_VIGENTE_SICREB" DataType="System.Double" />
                        <telerik:GridBoundColumn HeaderText="Saldo Vencido (Etiqueta 24)" DataField="SALDO_VENCIDO_SICREB" DataType="System.Double" />
                        <telerik:GridBoundColumn HeaderText="Saldo Total SICREB" DataField="SALDO_TOTAL_SICREB" DataType="System.Double" />
                        <telerik:GridBoundColumn HeaderText="Saldo Total SICOFIN" DataField="SALDO_TOTAL_SICOFIN" DataType="System.Double" />
                        <telerik:GridBoundColumn HeaderText="Saldo Total Diferencia" DataField="SALDO_TOTAL_DIFERENCIA" DataType="System.Double" />                        
        ...
        <table style="width:100%;">
                <tr>
                    <td style="background-color:#F1F5FB;" align="center" class="style2">SICREB</td>
                    <td style="background-color:#F1F5FB;" align="center" class="style3">SICOFIN</td>
                    <td style="background-color:#F1F5FB;" align="center">Diferencia</td>
                </tr>
            </table>
        <telerik:RadGrid 
                ...
                <MasterTableView AllowPaging="True" AllowSorting="True" CommandItemDisplay="None" AllowFilteringByColumn="True">
                    ...
                    <Columns>
                        ...
                        <telerik:GridBoundColumn 
                            HeaderText="Saldo Total SICREB" 
                            DataField="SALDO_TOTAL_SICREB"
                            DataType="System.Double"
                            UniqueName="SALDO_TOTAL_SICREB"
                            SortExpression="SALDO_TOTAL_SICREB" />
                        <telerik:GridBoundColumn 
                            HeaderText="Saldo Total SICOFIN" 
                            DataField="SALDO_TOTAL_SICOFIN"
                            DataType="System.Double"
                            UniqueName="SALDO_TOTAL_SICOFIN"
                            SortExpression="SALDO_TOTAL_SICOFIN" />
                        <telerik:GridBoundColumn 
                             HeaderText="Saldo Total DIFERENCIA" 
                             DataField="SALDO_TOTAL_DIFERENCIA"
                             DataType="System.Double"
                             UniqueName="SALDO_TOTAL_DIFERENCIA"
                             SortExpression="SALDO_TOTAL_DIFERENCIA" />                        
                        <telerik:GridBoundColumn 
