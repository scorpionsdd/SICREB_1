<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 	CodeFile="PersonasMoralesV2.aspx.cs" Inherits="PersonasMoralesV2" Theme="Banobras2011" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <telerik:RadAjaxManager ID="RAManager" runat="server" EnableViewState="true">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="rgArchivoMorales">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgArchivoMorales" />
                </UpdatedControls>
            </telerik:AjaxSetting>
	...
	<div class="divCard">
		<div class="divHeader">&nbsp;PROCESO DE PERSONAS MORALES</div>
		...
		<div class="divCard" >
			...
			<div class="divGrid">
                ...
                <telerik:RadGrid runat="server" ID="rgArchivoMorales" AllowPaging="True" AllowSorting="True" OnItemCommand="grids_ItemCommand" GridLines="None" Skin="Banobras2011"
					             AutoGenerateColumns="False" OnNeedDataSource="rgArchivoMorales_NeedDataSource" AllowFilteringByColumn="true" EnableEmbeddedSkins="false" >
		...
		<div class="divCard">
			...
			<div class="divGrid">
				...
				<telerik:RadGrid ID="rgErrores" runat="server" AllowPaging="True" Width="968px" OnItemCommand="grids_ItemCommand"
					AllowSorting="True" GridLines="None" AutoGenerateColumns="False"  OnNeedDataSource="rgErrores_NeedDataSource" AllowFilteringByColumn="true" 
                    EnableEmbeddedSkins="false" Skin="Banobras2011">				  
					<ExportSettings ExportOnlyData="True" FileName="PM_Errores" IgnorePaging="True">
						<Pdf PageWidth="1000px" Title="Errores (PM)" />
					</ExportSettings>
					<PagerStyle Mode="NextPrevAndNumeric"  AlwaysVisible="true" 
							FirstPageToolTip="Primera Página"  
							PrevPageToolTip="Página Anterior"  
        ...
        <div class="divCard">
            ...
            <div class="divGrid">
				...
				<telerik:RadGrid ID="rgWarnings" runat="server" AllowPaging="True" Width="968px" OnItemCommand="grids_ItemCommand" 
					AllowSorting="True" GridLines="None" AutoGenerateColumns="False"  OnNeedDataSource="rgWarnings_NeedDataSource" AllowFilteringByColumn="true" 
                    EnableEmbeddedSkins="false" Skin="Banobras2011">
				  
					<ExportSettings ExportOnlyData="True" FileName="PM_Warnings" IgnorePaging="True">
						<Pdf PageWidth="1000px" Title="Warnings (PM)" />
					</ExportSettings>
					<PagerStyle Mode="NextPrevAndNumeric"  AlwaysVisible="true" 
							FirstPageToolTip="Primera Página"  
							PrevPageToolTip="Página Anterior"  
